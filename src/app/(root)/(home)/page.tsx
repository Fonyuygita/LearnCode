    ...
    <div className="flex-center paddings mx-auto w-full max-w-screen-2xl flex-col">
          ...
          <div className="mt-12 grid w-full grid-cols-4  max-md:grid-cols-1 justify-center gap-16 sm:justify-start">
            ...
            {resources?.length > 0 ? (
              resources.map((resource: any) => (
                <div
                  className="box bg-[#0a030318] rounded-lg shadow-lg  hover:shadow-xl p-6 transition-all duration-100 grid  grid-cols-1
      ...
      {resourcesPlayList.map((item: any) => (
        ...
        >
          ...
          <div className="mt-12  w-full grid  grid-cols-3 justify-center gap-16 sm:justify-start max-md:grid-cols-1">
