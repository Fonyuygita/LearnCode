  ...
  return (
    <div className="container mx-auto p-4 mt-[160px]">
      <div className="flex gap-4 mb-4">
        ...
        <button onClick={() => setFilter('challenges')} className="text-white">Challenges</button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
        ...
        {filteredCourses.map((course) => (
          <div key={course.id} className="card">
            <Link href={`/resources/${course.id}`} className='box bg-[#0a030318] rounded-lg hover:bg-[#3f349866] shadow-lg  hover:shadow-xl p-6 transition-opacity duration-100 grid  grid-cols-1
                 max-md:grid-cols-1 focus:bg-[#111]  border-b-2 border-red-500 '>
